...
export const shopItems: ShopItem[] = [
  ...
  { id: 'cards-dice-diamonds', category: 'cards', name: 'Кости и бубны', description: 'Бело-синяя колода с игровыми кубиками', price: 190, art: '10♦', image: '/assets/shop/dice-diamonds-card.jpg', colors: ['#49aaf2', '#101d38'], slot: 'deck' },
  { id: 'cards-mechanical-ace', category: 'cards', name: 'Механический туз', description: 'Колода с объёмным синим орнаментом', price: 260, art: 'A♠', image: '/assets/shop/mechanical-ace-card.jpg', colors: ['#6174c9', '#131943'], slot: 'deck' },
